  ...
  return (
    <Layout>
      <Sider collapsedWidth="0">
        <img src="https://gw.alipayobjects.com/zos/bmw-prod/8a74c1d3-16f3-4719-be63-15e467a68a24/km0cv8vn_w500_h500.png" className='page-logo' alt="" />
        <span style={{ color: 'white', fontSize: '18px', marginLeft: '4px' }}>qiankun</span>
        <Menu
          theme="dark"
          mode="inline"
